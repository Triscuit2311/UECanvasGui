...
namespace SDK
{
	...
	{
	public:
		TSoftObjectPtr<class AActor>                                 ActorToTrack;                                            // 0x0000(0x0024) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		struct PCoreUObject_FColor                                   DebugFocusPlaneColor;                                    // 0x0044(0x0004) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x10];                                  // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TSoftObjectPtr<class AActor>                                 ActorToTrack;                                            // 0x0018(0x0024) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x003C(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (PADDING)
	};
