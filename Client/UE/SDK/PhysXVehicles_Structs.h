...
namespace SDK
{
	...
	{
	public:
		class UVehicleWheel*                                         WheelClass;                                              // 0x0000(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x00C8(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0770(0x0010) MISSED OFFSET (PADDING)
	};
