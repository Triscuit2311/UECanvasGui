...
public:
	...
	static void SortByPredicate(TArray<struct FAssetData>& Assets, TDelegate<void(struct FAssetData& Left, struct FAssetData& Right)> SortingPredicate, EAssetRegistrySortOrder SortOrder);
