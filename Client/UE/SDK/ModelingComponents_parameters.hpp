...
static_assert(alignof(LineSetComponent_AddLines) == 0x000008, "Wrong alignment on LineSetComponent_AddLines");
static_assert(sizeof(LineSetComponent_AddLines) == 0x000030, "Wrong size on LineSetComponent_AddLines");
static_assert(offsetof(LineSetComponent_AddLines, InStart) == 0x000000, "Member 'LineSetComponent_AddLines::InStart' has a wrong offset!");
static_assert(offsetof(LineSetComponent_AddLines, InEnd) == 0x000010, "Member 'LineSetComponent_AddLines::InEnd' has a wrong offset!");
static_assert(offsetof(LineSetComponent_AddLines, InColor) == 0x000020, "Member 'LineSetComponent_AddLines::InColor' has a wrong offset!");
static_assert(offsetof(LineSetComponent_AddLines, InThickness) == 0x000024, "Member 'LineSetComponent_AddLines::InThickness' has a wrong offset!");
static_assert(offsetof(LineSetComponent_AddLines, InDepthBias) == 0x000028, "Member 'LineSetComponent_AddLines::InDepthBias' has a wrong offset!");
static_assert(offsetof(LineSetComponent_AddLines, ReturnValue) == 0x00002C, "Member 'LineSetComponent_AddLines::ReturnValue' has a wrong offset!");
...
static_assert(alignof(LineSetComponent_SetLineMaterial) == 0x000008, "Wrong alignment on LineSetComponent_SetLineMaterial");
static_assert(sizeof(LineSetComponent_SetLineMaterial) == 0x000008, "Wrong size on LineSetComponent_SetLineMaterial");
static_assert(offsetof(LineSetComponent_SetLineMaterial, InLineMaterial) == 0x000000, "Member 'LineSetComponent_SetLineMaterial::InLineMaterial' has a wrong offset!");
...
static_assert(sizeof(ModelingObjectsCreationAPI_CreateTextureObject) == 0x000050, "Wrong size on ModelingObjectsCreationAPI_CreateTextureObject");
...
static_assert(offsetof(ModelingObjectsCreationAPI_CreateTextureObject, ReturnValue) == 0x000040, "Member 'ModelingObjectsCreationAPI_CreateTextureObject::ReturnValue' has a wrong offset!");
