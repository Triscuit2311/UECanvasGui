...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0004[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0005[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0006[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x20];                                  // 0x0080(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x160];                                 // 0x0000(0x0160) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x2];                                   // 0x0026(0x0002) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0xB];                                   // 0x00E5(0x000B) MISSED OFFSET (PADDING)
	};
