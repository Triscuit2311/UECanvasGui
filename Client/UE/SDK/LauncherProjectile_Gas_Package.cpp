...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(91769);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(91768);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(91767);
		return ptr;
	}
