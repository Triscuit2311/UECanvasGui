...
namespace SDK
{
	 ...
	 */
	class ABP_CratesPile_06_C : public AActor
	{
	public:
		class UStaticMeshComponent*                                  StaticMeshComponent05;                                   // 0x0220(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
