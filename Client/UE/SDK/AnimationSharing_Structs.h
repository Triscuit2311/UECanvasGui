...
namespace SDK
{
	...
	public:
		...
		class UAnimSharingStateInstance*                             AnimBlueprint;                                           // 0x0008(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                                UnknownData_0002[0x1];                                   // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		class UAnimSharingTransitionInstance*                        BlendAnimBlueprint;                                      // 0x0010(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		class UAnimSharingAdditiveInstance*                          AdditiveAnimBlueprint;                                   // 0x0018(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		class UAnimationSharingStateProcessor*                       StateProcessorClass;                                     // 0x0020(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
