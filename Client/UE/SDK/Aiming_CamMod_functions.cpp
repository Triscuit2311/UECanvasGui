...
#include "Aiming_CamMod_classes.hpp"
#include "Aiming_CamMod_parameters.hpp"
...
void UAiming_CamMod_C::BlueprintModifyCamera(float DeltaTime, const struct FVector& ViewLocation, const struct FRotator& ViewRotation, float FOV, struct FVector* NewViewLocation, struct FRotator* NewViewRotation, float* NewFOV)
{
	...
	Params::Aiming_CamMod_C_BlueprintModifyCamera Parms{};
