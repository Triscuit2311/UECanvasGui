...
#include "BP_Loot_Crate_Master_Dungeon_UI_Inventory_parameters.hpp"
...
void ABP_Loot_Crate_Master_Dungeon_UI_Inventory_C::BndEvt__BP_Loot_Crate_Master_Dungeon_UI_Inventory_InteractCollisionComp_K2Node_ComponentBoundEvent_0_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	...
	Params::BP_Loot_Crate_Master_Dungeon_UI_Inventory_C_BndEvt__BP_Loot_Crate_Master_Dungeon_UI_Inventory_InteractCollisionComp_K2Node_ComponentBoundEvent_0_ComponentEndOverlapSignature__DelegateSignature Parms{};
...
void ABP_Loot_Crate_Master_Dungeon_UI_Inventory_C::ExecuteUbergraph_BP_Loot_Crate_Master_Dungeon_UI_Inventory(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_Loot_Crate_Master_Dungeon_UI_Inventory_C_ExecuteUbergraph_BP_Loot_Crate_Master_Dungeon_UI_Inventory Parms{};
