...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x1D];                                  // 0x00CB(0x001D) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x1];                                   // 0x0054(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x2];                                   // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<int32_t>                                              RowsDisabled;                                            // 0x0058(0x0010) ZeroConstructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x0068(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		class UMulticastInlineDelegate                               OnPlay;                                                  // 0x0260(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0261(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnPlayReverse;                                           // 0x0270(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x0271(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnStop;                                                  // 0x0280(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x0281(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnPause;                                                 // 0x0290(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0004[0xF];                                   // 0x0291(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnFinished;                                              // 0x02A0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0005[0xF];                                   // 0x02A1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                                UnknownData_0006[0x3];                                   // 0x02B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0007[0x3];                                   // 0x02B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0008[0x4];                                   // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0009[0x68];                                  // 0x03D0(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0010[0x88];                                  // 0x0460(0x0088) MISSED OFFSET (PADDING)
	...
	public:
		...
		uint8_t                                                      NetworkMask;                                             // 0x0118(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x58];                                  // 0x0038(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x28];                                  // 0x0040(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x5];                                   // 0x03F3(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0xB0];                                  // 0x0028(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x18];                                  // 0x0218(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x90];                                  // 0x0040(0x0090) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x270];                                 // 0x0028(0x0270) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FMovieSceneEntitySystemGraph                          SystemGraph;                                             // 0x0298(0x0138) NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0x120];                                 // 0x03D0(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x00E8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x7];                                   // 0x00F9(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0180(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0100(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0xB0];                                  // 0x0040(0x00B0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x6];                                   // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
