...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x6];                                   // 0x0092(0x0006) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x033C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x0A89(0x0007) MISSED OFFSET (PADDING)
	};
