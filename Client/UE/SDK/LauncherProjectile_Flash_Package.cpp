...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(91660);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(91659);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(91658);
		return ptr;
	}
