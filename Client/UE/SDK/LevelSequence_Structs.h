...
namespace SDK
{
	...
	{
	public:
		uint8_t                                                      ZeroPadAmount;                                           // 0x0000(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		TSoftObjectPtr<class UCameraComponent>                       CameraComponent;                                         // 0x0070(0x0024) ELEMENT_SIZE_MISMATCH Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, EditConst, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x0094(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	};
