...
namespace SDK
{
	...
	public:
		...
		class UObject*                                               AreaClass;                                               // 0x0018(0x0008) ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	};
	...
	{
	public:
		class UNavArea*                                              AreaClass;                                               // 0x0000(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
