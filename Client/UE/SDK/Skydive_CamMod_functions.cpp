...
#include "Skydive_CamMod_classes.hpp"
#include "Skydive_CamMod_parameters.hpp"
...
void USkydive_CamMod_C::BlueprintModifyCamera(float DeltaTime, const struct FVector& ViewLocation, const struct FRotator& ViewRotation, float FOV, struct FVector* NewViewLocation, struct FRotator* NewViewRotation, float* NewFOV)
{
	...
	Params::Skydive_CamMod_C_BlueprintModifyCamera Parms{};
