...
namespace SDK
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Meth_WindowDest.BP_Meth_WindowDest_C
	 * Size -> 0x0018 (FullSize[0x0238] - InheritedSize[0x0220])
	 */
	class ABP_Meth_WindowDest_C : public AActor
	{
	public:
		class UChildActorComponent*                                  BP_GlassActor;                                           // 0x0220(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
