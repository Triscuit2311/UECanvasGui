...
public:
	...
	uint8                                        Pad_1BD3[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1BDC[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1BE0[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BE1[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
