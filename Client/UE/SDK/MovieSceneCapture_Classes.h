...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x70];                                  // 0x0068(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x6];                                   // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x110];                                 // 0x0110(0x0110) MISSED OFFSET (PADDING)

	public:
		void SetImageCaptureProtocolType(class UMovieSceneCaptureProtocolBase* ProtocolType);
		void SetAudioCaptureProtocolType(class UMovieSceneCaptureProtocolBase* ProtocolType);
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0xB];                                   // 0x0221(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x78];                                  // 0x0060(0x0078) MISSED OFFSET (PADDING)
