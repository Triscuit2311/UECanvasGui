...
// Enum CommonUI.ECommonUIAnimation
// NumValues: 0x0007
...
struct alignas(0x04) FCommonUIAnimation final
{
public:
	uint8                                         Pad_0[0x1C];                                       // 0x0000(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCommonUIAnimation) == 0x000004, "Wrong alignment on FCommonUIAnimation");
static_assert(sizeof(FCommonUIAnimation) == 0x00001C, "Wrong size on FCommonUIAnimation");
...
struct alignas(0x08) FCommonUICanvasPanelJiggleInstance final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCommonUICanvasPanelJiggleInstance) == 0x000008, "Wrong alignment on FCommonUICanvasPanelJiggleInstance");
static_assert(sizeof(FCommonUICanvasPanelJiggleInstance) == 0x000028, "Wrong size on FCommonUICanvasPanelJiggleInstance");
