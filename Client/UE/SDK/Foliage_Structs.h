...
namespace SDK
{
	...
	public:
		...
		class UFoliageType_InstancedStaticMesh*                      Type;                                                    // 0x0018(0x0008) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	};
	...
	{
	public:
		struct PCoreUObject_FQuat                                    Rotation;                                                // 0x0000(0x0010) IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
