...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(36444);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(36443);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(36442);
		return ptr;
	}
