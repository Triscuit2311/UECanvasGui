...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0xC];                                   // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x8];                                   // 0x0618(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
