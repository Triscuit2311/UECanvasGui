...
static_assert(alignof(TraceUtilLibrary_TraceScreenshot) == 0x000008, "Wrong alignment on TraceUtilLibrary_TraceScreenshot");
static_assert(sizeof(TraceUtilLibrary_TraceScreenshot) == 0x000018, "Wrong size on TraceUtilLibrary_TraceScreenshot");
static_assert(offsetof(TraceUtilLibrary_TraceScreenshot, Name_0) == 0x000000, "Member 'TraceUtilLibrary_TraceScreenshot::Name_0' has a wrong offset!");
static_assert(offsetof(TraceUtilLibrary_TraceScreenshot, bShowUI) == 0x000010, "Member 'TraceUtilLibrary_TraceScreenshot::bShowUI' has a wrong offset!");
