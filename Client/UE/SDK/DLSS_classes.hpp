...
public:
	...
	uint8                                        Pad_98C[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_996[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class EDLSSPreset                       DLSSQualityPreset;                                 // 0x5B(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSBalancedPreset;                                // 0x5C(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSPerformancePreset;                             // 0x5D(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSUltraPerformancePreset;                        // 0x5E(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
