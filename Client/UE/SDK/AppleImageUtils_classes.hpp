...
public:
	...
	TMulticastInlineDelegate<void(struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
