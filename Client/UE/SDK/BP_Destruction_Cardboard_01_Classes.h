...
namespace SDK
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Destruction_Cardboard_01.BP_Destruction_Cardboard_01_C
	 * Size -> 0x0018 (FullSize[0x0270] - InheritedSize[0x0258])
	 */
	class ABP_Destruction_Cardboard_01_C : public ADynamicWorldItem
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Destruction_Cardboard_01(int32_t EntryPoint);
