...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		uint8_t                                                      TerrainMembership[0x4];                                  // 0x0038(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	{
	public:
		TSoftObjectPtr<class UPaperSprite>                           SpriteRef;                                               // 0x0000(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
