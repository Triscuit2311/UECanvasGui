...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(26997);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(26996);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(26995);
		return ptr;
	}
