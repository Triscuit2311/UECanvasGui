...
namespace SDK
{
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(9);
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(17);
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(14);
		return ptr;
	}
