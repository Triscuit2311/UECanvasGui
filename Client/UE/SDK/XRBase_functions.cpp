...
// Parameters:
// class UObject*                          WorldContext                                           (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EXRSpaceType                            XRSpaceType                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EControllerHand                         Hand                                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FXRHandTrackingState             HandTrackingState                                      (Parm, OutParm, NativeAccessSpecifierPublic)

void UHeadMountedDisplayFunctionLibrary::GetHandTrackingState(class UObject* WorldContext, const EXRSpaceType XRSpaceType, const EControllerHand Hand, struct FXRHandTrackingState* HandTrackingState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("HeadMountedDisplayFunctionLibrary", "GetHandTrackingState");

	Params::HeadMountedDisplayFunctionLibrary_GetHandTrackingState Parms{};

	Parms.WorldContext = WorldContext;
	Parms.XRSpaceType = XRSpaceType;
	Parms.Hand = Hand;
	...
	if (HandTrackingState != nullptr)
		*HandTrackingState = std::move(Parms.HandTrackingState);
}
...
// EXRSpaceType                            XRSpaceType                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EControllerHand                         Hand                                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EXRControllerPoseType                   ControllerPoseType                                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FXRMotionControllerState         MotionControllerState                                  (Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)

void UHeadMountedDisplayFunctionLibrary::GetMotionControllerState(class UObject* WorldContext, const EXRSpaceType XRSpaceType, const EControllerHand Hand, const EXRControllerPoseType ControllerPoseType, struct FXRMotionControllerState* MotionControllerState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("HeadMountedDisplayFunctionLibrary", "GetMotionControllerState");

	Params::HeadMountedDisplayFunctionLibrary_GetMotionControllerState Parms{};

	Parms.WorldContext = WorldContext;
	Parms.XRSpaceType = XRSpaceType;
	Parms.Hand = Hand;
	Parms.ControllerPoseType = ControllerPoseType;
	...
	if (MotionControllerState != nullptr)
		*MotionControllerState = std::move(Parms.MotionControllerState);
}
