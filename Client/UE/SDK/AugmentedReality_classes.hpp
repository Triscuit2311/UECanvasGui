...
public:
	...
	uint8                                         Pad_38C[0x64];                                     // 0x038C(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UAREnvironmentCaptureProbe*             CaptureProbe;                                      // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
