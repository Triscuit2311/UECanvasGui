...
// 0x0038 (0x0038 - 0x0000)
struct NavLinkProxy_SetSmartLinkEndpoints final
{
public:
	struct FVector                                Left;                                              // 0x0000(0x0018)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Right;                                             // 0x0018(0x0018)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(NavLinkProxy_SetSmartLinkEndpoints) == 0x000008, "Wrong alignment on NavLinkProxy_SetSmartLinkEndpoints");
static_assert(sizeof(NavLinkProxy_SetSmartLinkEndpoints) == 0x000038, "Wrong size on NavLinkProxy_SetSmartLinkEndpoints");
static_assert(offsetof(NavLinkProxy_SetSmartLinkEndpoints, Left) == 0x000000, "Member 'NavLinkProxy_SetSmartLinkEndpoints::Left' has a wrong offset!");
static_assert(offsetof(NavLinkProxy_SetSmartLinkEndpoints, Right) == 0x000018, "Member 'NavLinkProxy_SetSmartLinkEndpoints::Right' has a wrong offset!");
static_assert(offsetof(NavLinkProxy_SetSmartLinkEndpoints, Direction) == 0x000030, "Member 'NavLinkProxy_SetSmartLinkEndpoints::Direction' has a wrong offset!");
