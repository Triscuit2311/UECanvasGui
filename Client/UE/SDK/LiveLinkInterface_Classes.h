...
namespace SDK
{
	...
	public:
		...
		class ULiveLinkSourceFactory*                                Factory;                                                 // 0x0098(0x0008) Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		class ULiveLinkRole*                                         Role;                                                    // 0x0050(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
