...
public:
	...
	struct FDirectoryPath                         SequencePath;                                      // 0x00C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UImgMediaSource) == 0x0000E8, "Wrong size on UImgMediaSource");
...
static_assert(offsetof(UImgMediaSource, StartTimecode) == 0x0000AC, "Member 'UImgMediaSource::StartTimecode' has a wrong offset!");
static_assert(offsetof(UImgMediaSource, SequencePath) == 0x0000C8, "Member 'UImgMediaSource::SequencePath' has a wrong offset!");
