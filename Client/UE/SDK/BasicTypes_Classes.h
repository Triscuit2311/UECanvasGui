...
namespace SDK
{
	...
	public:
		/**
		 * For 32bit games this should not be 0x10(i think xD)
		 */
		uint8_t                                                      Data_InlineData[0x10];                                   // 0x0000(0x0000)
		int32_t*                                                     Data_SecondaryData;                                      // 0x0000(0x0000)
		int32_t                                                      NumBits;                                                 // 0x0000(0x0000)
		int32_t                                                      MaxBits;                                                 // 0x0000(0x0000)
	};

	/**
	 * PredefinedClass BasicTypes.TSparseArray
	 * Size -> 0x0000
	 */
	...
	public:
		/**
		 * Should be 'TArray<TSparseArrayElementOrListLink<ArrayType>>' but im lazy
		 */
		TArray<ArrayType>                                            Data;                                                    // 0x0000(0x0000)
		TBitArray                                                    AllocationFlags;                                         // 0x0000(0x0000)
		int32_t                                                      FirstFreeIndex;                                          // 0x0000(0x0000)
		int32_t                                                      NumFreeIndices;                                          // 0x0000(0x0000)
	...
	public:
		...
		bool IsValidIndex(int32_t i) const
		{
			return AllocationFlags.IsSet(i);
		}
		ArrayType& operator[](int32_t i)
		{
			return *(ArrayType*)&Data[i];
		}
		const ArrayType& operator[](int32_t i) const
		{
			return *(const ArrayType*)&Data[i];
		}
	};
	...
	/**
	 * PredefinedClass BasicTypes.UScriptMulticastDelegate
	 * Size -> 0x0000
	 */
	...
	/**
	 * PredefinedClass BasicTypes.UMulticastSparseDelegate
	 * Size -> 0x0000
	 */
	...
	/**
	 * PredefinedClass BasicTypes.UMulticastInlineDelegate
	 * Size -> 0x0000
	 */
	...
	#endif
	/**
	 * PredefinedClass BasicTypes.TSet
	 * Size -> 0x0000
	 */
	...
	{
	public:
		TSparseArray<TSetElement<TSetType>>                          Elements;                                                // 0x0000(0x0000)
		/**
		 * For 32bit games this should be 0x04(i think xD)
		 */
		uint8_t                                                      Hash_InlineData[0x08];                                   // 0x0000(0x0000)
		int32_t*                                                     Hash_SecondaryData;                                      // 0x0000(0x0000)
		int32_t                                                      HashSize;                                                // 0x0000(0x0000)
	};
 ...
 */
	...
	/**
	 * PredefinedClass BasicTypes.FSoftObjectPath_
	 * Size -> 0x0000
	 */
	...
	/**
	 * PredefinedClass BasicTypes.FSoftObjectPtr
	 * Size -> 0x0000
	 */
	...
	/**
	 * PredefinedClass BasicTypes.TSoftObjectPtr
	 * Size -> 0x0000
	 */
	...
	/**
	 * PredefinedClass BasicTypes.TSoftClassPtr
	 * Size -> 0x0000
	 */
	template<typename UEType>
