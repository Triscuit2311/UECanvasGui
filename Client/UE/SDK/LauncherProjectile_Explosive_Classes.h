...
namespace SDK
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass LauncherProjectile_Explosive.LauncherProjectile_Explosive_C
	 * Size -> 0x0008 (FullSize[0x03D0] - InheritedSize[0x03C8])
	 */
	class ALauncherProjectile_Explosive_C : public ALauncherProjectile_Base_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_LauncherProjectile_Explosive(int32_t EntryPoint);
