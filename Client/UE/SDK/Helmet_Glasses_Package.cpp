...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(86611);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(86610);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(86609);
		return ptr;
	}
