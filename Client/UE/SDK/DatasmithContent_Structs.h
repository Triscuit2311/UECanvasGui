...
namespace SDK
{
	...
	public:
		...
		TSoftObjectPtr<class AActor>                                 ActorToTrack;                                            // 0x0008(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x002C(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
