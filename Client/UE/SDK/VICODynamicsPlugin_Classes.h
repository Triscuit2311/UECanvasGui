...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0015[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                                UnknownData_0000[0x2];                                   // 0x04EE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x1];                                   // 0x04FF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                         AdjustOtherParticleLocationsBasedOnAttachments : 1;      // 0x0518(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                         AffectedByGlobalWind : 1;                                // 0x0518(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                         UseExplicitRigidBodyCollision : 1;                       // 0x0518(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x0519(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x0531(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UMulticastInlineDelegate                               OnSimulationDataCreated;                                 // 0x0578(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0004[0xF];                                   // 0x0579(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnSimulationSync;                                        // 0x0588(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0005[0xF];                                   // 0x0589(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		bool                                                         ShowParticles : 1;                                       // 0x0598(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0006[0x3];                                   // 0x0599(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0007[0x3];                                   // 0x05A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                         UnknownData_0008 : 5;                                    // 0x05AC(0x0001) BIT_FIELD (PADDING)
		bool                                                         SkipRelativeVelocityCheckDuringRigidBodyCollisions : 1;  // 0x05AC(0x0001) BIT_FIELD Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		bool                                                         EnableParticleToParticleCollisions : 1;                  // 0x05AC(0x0001) BIT_FIELD Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		bool                                                         ConsiderInnerCollisions : 1;                             // 0x05AC(0x0001) BIT_FIELD Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		bool                                                         bNotifyOnVDCollision : 1;                                // 0x05AD(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0009[0x2];                                   // 0x05AE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMulticastInlineDelegate                               OnVDCollisionEvent;                                      // 0x05B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0010[0xF];                                   // 0x05B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                                UnknownData_0011[0x20];                                  // 0x0610(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0012[0x20];                                  // 0x0640(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                         bUseLocationCache : 1;                                   // 0x0660(0x0001) BIT_FIELD Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		bool                                                         bApplyCachedStartLocationBeforeAttachToRigids : 1;       // 0x0660(0x0001) BIT_FIELD Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		unsigned char                                                UnknownData_0013[0x7];                                   // 0x0661(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                                UnknownData_0003[0x4];                                   // 0x0678(0x0004) Fix Super Size
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x0695(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x20];                                  // 0x06A0(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0004[0x8];                                   // 0x06F0(0x0008) Fix size for supers
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                         bCachePerFrameResults : 1;                               // 0x0064(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                         bCacheOnlyCollisionsWithStaticRigidBodies : 1;           // 0x0064(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                         bCacheNonHitsAlso : 1;                                   // 0x0064(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x130];                                 // 0x0028(0x0130) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x0264(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                         bAutoAttachToSplineEndPoints : 1;                        // 0x0720(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		bool                                                         bStretchToSplineLength : 1;                              // 0x0720(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
	...
	{
	public:
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x01F8(0x0004) Fix Super Size
		...
		unsigned char                                                UnknownData_0000[0x1C];                                  // 0x0224(0x001C) MISSED OFFSET (PADDING)
