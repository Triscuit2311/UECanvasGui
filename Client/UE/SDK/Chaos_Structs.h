...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (PADDING)
	};
