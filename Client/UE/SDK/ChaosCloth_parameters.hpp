...
static_assert(alignof(ChaosClothingInteractor_SetMaterialBuckling) == 0x000008, "Wrong alignment on ChaosClothingInteractor_SetMaterialBuckling");
...
static_assert(offsetof(ChaosClothingInteractor_SetMaterialBuckling, BucklingRatio) == 0x000000, "Member 'ChaosClothingInteractor_SetMaterialBuckling::BucklingRatio' has a wrong offset!");
static_assert(offsetof(ChaosClothingInteractor_SetMaterialBuckling, BucklingStiffness) == 0x000010, "Member 'ChaosClothingInteractor_SetMaterialBuckling::BucklingStiffness' has a wrong offset!");
...
static_assert(offsetof(ChaosClothingInteractor_SetWind, OuterDrag) == 0x000040, "Member 'ChaosClothingInteractor_SetWind::OuterDrag' has a wrong offset!");
static_assert(offsetof(ChaosClothingInteractor_SetWind, OuterLift) == 0x000050, "Member 'ChaosClothingInteractor_SetWind::OuterLift' has a wrong offset!");
