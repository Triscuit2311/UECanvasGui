...
struct FWwiseAssetLibraryCookedData final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FWwisePackagedFile>             PackagedFiles;                                     // 0x0008(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NativeAccessSpecifierPublic)
	class FName                                   DebugName;                                         // 0x0018(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWwiseAssetLibraryCookedData) == 0x000008, "Wrong alignment on FWwiseAssetLibraryCookedData");
static_assert(sizeof(FWwiseAssetLibraryCookedData) == 0x000020, "Wrong size on FWwiseAssetLibraryCookedData");
static_assert(offsetof(FWwiseAssetLibraryCookedData, PackagedFiles) == 0x000008, "Member 'FWwiseAssetLibraryCookedData::PackagedFiles' has a wrong offset!");
static_assert(offsetof(FWwiseAssetLibraryCookedData, DebugName) == 0x000018, "Member 'FWwiseAssetLibraryCookedData::DebugName' has a wrong offset!");
...
{
public:
	TArray<struct FWwiseSoundBankCookedData>      SoundBanks;                                        // 0x0048(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FWwiseMediaCookedData>          Media;                                             // 0x0058(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FWwiseLanguageCookedData>       Language;                                          // 0x0068(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FWwiseInitBankCookedData, SoundBanks) == 0x000048, "Member 'FWwiseInitBankCookedData::SoundBanks' has a wrong offset!");
static_assert(offsetof(FWwiseInitBankCookedData, Media) == 0x000058, "Member 'FWwiseInitBankCookedData::Media' has a wrong offset!");
static_assert(offsetof(FWwiseInitBankCookedData, Language) == 0x000068, "Member 'FWwiseInitBankCookedData::Language' has a wrong offset!");
