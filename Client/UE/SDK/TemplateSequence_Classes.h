...
namespace SDK
{
	...
	public:
		...
		TSoftClassPtr<class AActor>                                  BoundActorClass;                                         // 0x0068(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x008C(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
		TSoftObjectPtr<class AActor>                                 BoundPreviewActor;                                       // 0x0090(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x00B4(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x2A8];                                 // 0x0028(0x02A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x60];                                  // 0x03C8(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
