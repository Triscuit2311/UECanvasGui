...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x60];                                  // 0x0050(0x0060) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		class UCameraShakeBase*                                      ShakeClass;                                              // 0x0000(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x60];                                  // 0x0028(0x0060) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		class UCameraShakeBase*                                      ShakeClass;                                              // 0x0000(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x67];                                  // 0x0039(0x0067) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0002[0x2];                                   // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x00DD(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0018(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x00D1(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x1C];                                  // 0x001C(0x001C) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (PADDING)
	};
