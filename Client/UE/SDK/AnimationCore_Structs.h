...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (PADDING)
	};
