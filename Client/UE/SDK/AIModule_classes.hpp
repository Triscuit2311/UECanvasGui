...
public:
	...
	bool                                          bScoreOnlyWithinRange;                             // 0x023A(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UEnvQueryTest_Dot, bScoreOnlyWithinRange) == 0x00023A, "Member 'UEnvQueryTest_Dot::bScoreOnlyWithinRange' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class AActor* MovingActor, struct FVector& DestinationPoint)> OnSmartLinkReached;                                // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	TMulticastInlineDelegate<void(class AActor* MovingActor, struct FVector& DestinationPoint)> OnSmartLinkReached;                                // 0x02E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)

public:
	void ReceiveSmartLinkReached(class AActor* Agent, const struct FVector& Destination);
	void ResumePathFollowing(class AActor* Agent);
	void SetSmartLinkEnabled(bool bEnabled);
	void SetSmartLinkEndpoints(const struct FVector& Left, const struct FVector& Right, ENavLinkDirection Direction);
