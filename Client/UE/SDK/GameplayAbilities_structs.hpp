...
static_assert(sizeof(FGameplayAbilityTargetingLocationInfo) == 0x000090, "Wrong size on FGameplayAbilityTargetingLocationInfo");
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, SourceActor) == 0x000008, "Member 'FGameplayAbilityTargetingLocationInfo::SourceActor' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, SourceComponent) == 0x000010, "Member 'FGameplayAbilityTargetingLocationInfo::SourceComponent' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, SourceAbility) == 0x000018, "Member 'FGameplayAbilityTargetingLocationInfo::SourceAbility' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, SourceSocketName) == 0x000080, "Member 'FGameplayAbilityTargetingLocationInfo::SourceSocketName' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, LocationType) == 0x000088, "Member 'FGameplayAbilityTargetingLocationInfo::LocationType' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityTargetData_ActorArray) == 0x0000B0, "Wrong size on FGameplayAbilityTargetData_ActorArray");
...
static_assert(offsetof(FGameplayAbilityTargetData_ActorArray, TargetActorArray) == 0x0000A0, "Member 'FGameplayAbilityTargetData_ActorArray::TargetActorArray' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, PredictionKey) == 0x00000C, "Member 'FGameplayAbilityLocalAnimMontage::PredictionKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, AnimatingAbility) == 0x00001C, "Member 'FGameplayAbilityLocalAnimMontage::AnimatingAbility' has a wrong offset!");
...
static_assert(offsetof(GameplayAbilities::FServerAbilityRPCBatch, PredictionKey) == 0x000004, "Member 'GameplayAbilities::FServerAbilityRPCBatch::PredictionKey' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PredictionKey) == 0x000024, "Member 'FGameplayAbilityRepAnimMontage::PredictionKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, SectionIdToPlay) == 0x000034, "Member 'FGameplayAbilityRepAnimMontage::SectionIdToPlay' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x000110, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000108, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityActivationInfo) == 0x000014, "Wrong size on FGameplayAbilityActivationInfo");
...
static_assert(alignof(FReplicatedPredictionKeyItem) == 0x000004, "Wrong alignment on FReplicatedPredictionKeyItem");
static_assert(sizeof(FReplicatedPredictionKeyItem) == 0x00001C, "Wrong size on FReplicatedPredictionKeyItem");
static_assert(offsetof(FReplicatedPredictionKeyItem, PredictionKey) == 0x00000C, "Member 'FReplicatedPredictionKeyItem::PredictionKey' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityTargetData_LocationInfo) == 0x000130, "Wrong size on FGameplayAbilityTargetData_LocationInfo");
...
static_assert(offsetof(FGameplayAbilityTargetData_LocationInfo, TargetLocation) == 0x0000A0, "Member 'FGameplayAbilityTargetData_LocationInfo::TargetLocation' has a wrong offset!");
...
public:
	...
	bool                                          bWasRetriggered;                                   // 0x000E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAbilityEndedData, bWasRetriggered) == 0x00000E, "Member 'FAbilityEndedData::bWasRetriggered' has a wrong offset!");
...
{
public:
	EGameplayEffectMagnitudeCalculation           MagnitudeCalculationType;                          // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         ScalableFloatMagnitude;                            // 0x0008(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	EGameplayModOp                                ModifierOp;                                        // 0x0038(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0040(0x01E0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0228(0x0088)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x02B0(0x0088)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FVector_NetQuantize                    WorldOrigin;                                       // 0x0060(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
