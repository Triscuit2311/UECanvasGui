...
namespace SDK
{
	...
	{
	public:
		class UMulticastInlineDelegate                               OnTrackedDeviceActivated;                                // 0x00B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x00B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnTrackedDeviceDeactivated;                              // 0x00C0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0002[0x18];                                  // 0x00F0(0x0018) MISSED OFFSET (PADDING)
