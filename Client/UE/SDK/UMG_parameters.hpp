...
// Function UMG.Widget.Show
// 0x0001 (0x0001 - 0x0000)
struct Widget_Show final
{
public:
...
static_assert(alignof(Widget_Show) == 0x000001, "Wrong alignment on Widget_Show");
static_assert(sizeof(Widget_Show) == 0x000001, "Wrong size on Widget_Show");
static_assert(offsetof(Widget_Show, Visible) == 0x000000, "Member 'Widget_Show::Visible' has a wrong offset!");
...
// Function UMG.ProgressBar.SetUseImageSize
// 0x0001 (0x0001 - 0x0000)
struct ProgressBar_SetUseImageSize final
{
public:
	bool                                          InbUseImageSize;                                   // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ProgressBar_SetUseImageSize) == 0x000001, "Wrong alignment on ProgressBar_SetUseImageSize");
static_assert(sizeof(ProgressBar_SetUseImageSize) == 0x000001, "Wrong size on ProgressBar_SetUseImageSize");
static_assert(offsetof(ProgressBar_SetUseImageSize, InbUseImageSize) == 0x000000, "Member 'ProgressBar_SetUseImageSize::InbUseImageSize' has a wrong offset!");
