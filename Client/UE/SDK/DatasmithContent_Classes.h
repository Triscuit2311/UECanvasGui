...
namespace SDK
{
	...
	public:
		...
		TSoftObjectPtr<class UTextureLightProfile>                   IESTexture;                                              // 0x0058(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x007C(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x5];                                   // 0x004B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x6];                                   // 0x0062(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0071(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x008C(0x0004) FIX WRONG SIZE OF PREVIOUS PROPERTY
