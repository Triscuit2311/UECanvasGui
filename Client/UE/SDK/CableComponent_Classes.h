...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x04D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x1C];                                  // 0x04F4(0x001C) MISSED OFFSET (PADDING)
