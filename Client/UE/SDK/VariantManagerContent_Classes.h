...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x60];                                  // 0x0028(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UObject*                                               LeafPropertyClass;                                       // 0x0128(0x0008) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		unsigned char                                                UnknownData_0002[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<uint8_t>                                              ValueBytes;                                              // 0x0138(0x0010) ZeroConstructor, Protected, NativeAccessSpecifierProtected
		...
		unsigned char                                                UnknownData_0003[0x6F];                                  // 0x0149(0x006F) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UObject*                                               DirectorClass;                                           // 0x0028(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	public:
		...
		TMap<class UObject*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                       // 0x0238(0x0050) Transient, NativeAccessSpecifierPrivate
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0050(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetThumbnailFromCamera(class UObject* WorldContextObject, const struct PCoreUObject_FTransform& CameraTransform, float FOVDegrees, float MinZ, float Gamma);
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
