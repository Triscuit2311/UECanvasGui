...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A95B240;
	constexpr int32 AppendString      = 0x0124EC40;
	constexpr int32 GNames            = 0x0A877400;
	constexpr int32 GWorld            = 0x0AADB878;
	constexpr int32 ProcessEvent      = 0x01499250;
