...
namespace SDK
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_PlayerSpeedIndicator_V2.W_PlayerSpeedIndicator_V2_C
	 * Size -> 0x0028 (FullSize[0x0318] - InheritedSize[0x02F0])
	 */
	class UW_PlayerSpeedIndicator_V2_C : public UPlayerSpeedIndicator_V2
	{
	public:
		...
		class UImage*                                                Image_321;                                               // 0x0310(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
