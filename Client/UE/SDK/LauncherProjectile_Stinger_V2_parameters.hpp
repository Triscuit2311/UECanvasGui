...
struct ALauncherProjectile_Stinger_V2_C_OnMeshHit_Params
{
public:
...
struct ALauncherProjectile_Stinger_V2_C_ExecuteUbergraph_LauncherProjectile_Stinger_V2_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_AC8[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UPrimitiveComponent*                   K2Node_Event_HitComponent;                         // 0x8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               K2Node_Event_NormalImpulse;                        // 0x20(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            K2Node_Event_Hit;                                  // 0x2C(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x14C(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
