...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x390];                                 // 0x0028(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UEditableMeshAdapter*>                          Adapters;                                                // 0x03B8(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0x8];                                   // 0x03C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x148];                                 // 0x03D4(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x1E4];                                 // 0x0524(0x01E4) MISSED OFFSET (PADDING)
