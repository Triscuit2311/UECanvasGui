...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x048D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UMulticastInlineDelegate                               OnFinishedPlaying;                                       // 0x04B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x04B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x18];                                  // 0x0498(0x0018) MISSED OFFSET (PADDING)

	public:
		bool UpdateInstanceTransform(int32_t InstanceIndex, const struct PCoreUObject_FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport);
		...
		bool GetInstanceTransform(int32_t InstanceIndex, struct PCoreUObject_FTransform* OutInstanceTransform, bool bWorldSpace);
		int32_t GetInstanceCount();
		void ClearInstances();
		int32_t AddInstance(const struct PCoreUObject_FTransform& Transform, class UPaperSprite* Sprite, bool bWorldSpace, const struct FLinearColor& Color);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x6];                                   // 0x045A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x0485(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x048C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x18];                                  // 0x0498(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		struct PCoreUObject_FTransform GetTileTransform(const struct FPaperTileInfo& Tile);
	...
	{
	public:
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x0478(0x0004) Fix Super Size
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x04BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x8];                                   // 0x04C8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		TSoftObjectPtr<class UPaperTileSet>                          SelectedTileSet;                                         // 0x0048(0x0024) ELEMENT_SIZE_MISMATCH UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0001[0x2];                                   // 0x008E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0550(0x0010) MISSED OFFSET (PADDING)
