...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0x2];                                   // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0005[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0006[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x14];                                  // 0x0044(0x0014) MISSED OFFSET (PADDING)
	};
