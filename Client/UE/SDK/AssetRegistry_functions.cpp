...
void UAssetRegistryHelpers::SortByPredicate(TArray<struct FAssetData>& Assets, TDelegate<void(struct FAssetData& Left, struct FAssetData& Right)> SortingPredicate, EAssetRegistrySortOrder SortOrder)
{
	static class UFunction* Func = nullptr;
