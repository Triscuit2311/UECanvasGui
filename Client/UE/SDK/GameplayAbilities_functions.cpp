...
// bool                                    bWasRetriggered                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGameplayAbility::K2_OnEndAbility(bool bWasCancelled, bool bWasRetriggered)
{
	static class UFunction* Func = nullptr;
...
struct FGameplayAbilitySpecHandle UGameplayAbility::GetCurrentAbilitySpecHandle() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayAbility", "GetCurrentAbilitySpecHandle");

	Params::GameplayAbility_GetCurrentAbilitySpecHandle Parms{};
...
void UAbilitySystemComponent::GetBlockedAbilityTags(struct FGameplayTagContainer* TagContainer) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "GetBlockedAbilityTags");

	Params::AbilitySystemComponent_GetBlockedAbilityTags Parms{};
