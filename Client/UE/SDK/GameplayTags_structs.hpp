...
{
public:
	uint8                                        Pad_1F2F[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1F31[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1F34[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1F3B[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
