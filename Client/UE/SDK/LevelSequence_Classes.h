...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0002[0x6];                                   // 0x0272(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x7];                                   // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0004[0x7];                                   // 0x02A1(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UObject*                                               DirectorClass;                                           // 0x01B0(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
	...
	{
	public:
		class UMulticastInlineDelegate                               OnCameraCut;                                             // 0x04E8(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x04E9(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0001[0x108];                                 // 0x04F8(0x0108) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0001[0xC];                                   // 0x023C(0x000C) MISSED OFFSET (PADDING)
