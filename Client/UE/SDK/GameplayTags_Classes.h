...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x138];                                 // 0x0028(0x0138) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<class FName, struct FGameplayTagSource>                 TagSources;                                              // 0x0160(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0001[0x80];                                  // 0x01B0(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		bool HasAllMatchingGameplayTags(const TScriptInterface<class IGameplayTagAssetInterface>& TagContainerInterface, const struct FGameplayTagContainer& OtherContainer);
		...
		void GetAllActorsOfClassMatchingTagQuery(class UObject* WorldContextObject, class AActor* ActorClass, const struct FGameplayTagQuery& GameplayTagQuery, TArray<class AActor*>* OutActors);
		...
		bool DoesTagAssetInterfaceHaveTag(const TScriptInterface<class IGameplayTagAssetInterface>& TagContainerInterface, const struct FGameplayTag& Tag);
