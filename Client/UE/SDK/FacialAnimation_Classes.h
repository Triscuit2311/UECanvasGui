...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0860(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x2C];                                  // 0x0874(0x002C) MISSED OFFSET (PADDING)
