...
namespace SDK
{
	...
	public:
		...
		class UObject* GetPossessedObjectClass(const struct FSequencerBindingProxy& InBinding);
		...
		TArray<class UMovieSceneTrack*> FindTracksByType(const struct FSequencerBindingProxy& InBinding, class UMovieSceneTrack* TrackType);
		TArray<class UMovieSceneTrack*> FindTracksByExactType(const struct FSequencerBindingProxy& InBinding, class UMovieSceneTrack* TrackType);
		class UMovieSceneTrack* AddTrack(const struct FSequencerBindingProxy& InBinding, class UMovieSceneTrack* TrackType);
		static UClass* StaticClass();
	};
	...
	public:
		...
		TArray<class UMovieSceneTrack*> FindMasterTracksByType(class UMovieSceneSequence* Sequence, class UMovieSceneTrack* TrackType);
		TArray<class UMovieSceneTrack*> FindMasterTracksByExactType(class UMovieSceneSequence* Sequence, class UMovieSceneTrack* TrackType);
		...
		struct FSequencerBindingProxy AddSpawnableFromClass(class UMovieSceneSequence* Sequence, class UObject* ClassToSpawn);
		...
		class UMovieSceneTrack* AddMasterTrack(class UMovieSceneSequence* Sequence, class UMovieSceneTrack* TrackType);
