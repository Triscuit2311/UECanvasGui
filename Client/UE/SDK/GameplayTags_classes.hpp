...
public:
	...
	uint8                                        Pad_1EF7[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F12[0x138];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x160(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1F14[0x80];                                    // Fixing Size After Last Property  [ Dumper-7 ]
