...
namespace SDK
{
	...
	{
	public:
		class UMulticastInlineDelegate                               OnHeadTrackingLost;                                      // 0x0140(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0141(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnHeadTrackingRecovered;                                 // 0x0150(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0151(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnHeadTrackingRecoveryFailed;                            // 0x0160(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x0161(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnHeadTrackingNewSessionStarted;                         // 0x0170(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x0171(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0004[0x50];                                  // 0x0180(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UMulticastInlineDelegate                               InAppPurchaseLogMessage;                                 // 0x00B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x00B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               GetItemsDetailsSuccess;                                  // 0x00C0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x00C1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               GetItemsDetailsFailure;                                  // 0x00D0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x00D1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               PurchaseConfirmationSuccess;                             // 0x00E0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x00E1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               PurchaseConfirmationFailure;                             // 0x00F0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0004[0xF];                                   // 0x00F1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               GetPurchaseHistorySuccess;                               // 0x0100(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0005[0xF];                                   // 0x0101(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               GetPurchaseHistoryFailure;                               // 0x0110(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0006[0xF];                                   // 0x0111(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0007[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		void SetBaseOrientation(const struct PCoreUObject_FQuat& InBaseOrientation);
		bool SetAppReady();
	...
	{
	public:
		unsigned char                                                UnknownData_0007[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		class UMulticastInlineDelegate                               OnMeshTrackerUpdated;                                    // 0x0200(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0001[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0004[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct PCoreUObject_FColor>                           BlockVertexColors;                                       // 0x0238(0x0010) Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0005[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0006[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		void ConnectBlockSelector(const TScriptInterface<class IMagicLeapMeshBlockSelectorInterface>& Selector);
		static UClass* StaticClass();
	};
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UMulticastInlineDelegate                               DeviceHasReactivatedDelegate;                            // 0x0140(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0141(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               DeviceWillEnterRealityModeDelegate;                      // 0x0150(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0151(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               DeviceWillGoInStandbyDelegate;                           // 0x0160(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x0161(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               FocusLostDelegate;                                       // 0x0170(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x0171(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               FocusGainedDelegate;                                     // 0x0180(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
