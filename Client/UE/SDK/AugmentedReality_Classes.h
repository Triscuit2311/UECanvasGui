...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<uint8_t>                                              WorldMapData;                                            // 0x0060(0x0010) Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected
		...
		unsigned char                                                UnknownData_0002[0x1];                                   // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<uint8_t>                                              SerializedARCandidateImageDatabase;                      // 0x0098(0x0010) ZeroConstructor, Protected, NativeAccessSpecifierProtected
		...
		unsigned char                                                UnknownData_0004[0x6];                                   // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UARPlaneComponent*                                     PlaneComponentClass;                                     // 0x00B0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARPointComponent*                                     PointComponentClass;                                     // 0x00B8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARFaceComponent*                                      FaceComponentClass;                                      // 0x00C0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARImageComponent*                                     ImageComponentClass;                                     // 0x00C8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARQRCodeComponent*                                    QRCodeComponentClass;                                    // 0x00D0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARPoseComponent*                                      PoseComponentClass;                                      // 0x00D8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UAREnvironmentProbeComponent*                          EnvironmentProbeComponentClass;                          // 0x00E0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARObjectComponent*                                    ObjectComponentClass;                                    // 0x00E8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARMeshComponent*                                      MeshComponentClass;                                      // 0x00F0(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		class UARGeoAnchorComponent*                                 GeoAnchorComponentClass;                                 // 0x00F8(0x0008) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
	...
	public:
		...
		void SetAlignmentTransform(const struct PCoreUObject_FTransform& InAlignmentTransform);
		...
		class UARPin* PinComponent(class USceneComponent* ComponentToPin, const struct PCoreUObject_FTransform& PinToWorldTransform, class UARTrackedGeometry* TrackedGeometry, const class FName& DebugName);
		void PauseARSession();
		...
		TArray<class UARTrackedGeometry*> GetAllGeometriesByClass(class UARTrackedGeometry* GeometryClass);
		TArray<class UARTrackedGeometry*> GetAllGeometries();
		struct PCoreUObject_FTransform GetAlignmentTransform();
		...
		void CalculateAlignmentTransform(const struct PCoreUObject_FTransform& TransformInFirstCoordinateSystem, const struct PCoreUObject_FTransform& TransformInSecondCoordinateSystem, struct PCoreUObject_FTransform* AlignmentTransform);
		bool AddTrackedPointWithName(const struct PCoreUObject_FTransform& WorldTransform, const class FString& PointName, bool bDeletePointsWithSameName);
	...
	public:
		...
		struct PCoreUObject_FTransform                               LocalToTrackingTransform;                                // 0x0040(0x0030) IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected
		struct PCoreUObject_FTransform                               LocalToAlignedTrackingTransform;                         // 0x0070(0x0030) IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected
		...
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x16];                                  // 0x00BA(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0xC];                                   // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0005[0x10];                                  // 0x00E8(0x0010) Fix size for supers
	...
	public:
		...
		struct PCoreUObject_FTransform GetLocalToWorldTransform();
		struct PCoreUObject_FTransform GetLocalToTrackingTransform();
	...
	public:
		...
		struct PCoreUObject_FTransform GetLocalTransform(const struct FARTraceResult& TraceResult);
		struct PCoreUObject_FTransform GetLocalToWorldTransform(const struct FARTraceResult& TraceResult);
		struct PCoreUObject_FTransform GetLocalToTrackingTransform(const struct FARTraceResult& TraceResult);
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0148(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x01D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x00F8(0x0004) Fix Super Size
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x00F8(0x0008) Fix Super Size
	...
	{
	public:
		unsigned char                                                UnknownData_0001[0x8];                                   // 0x00F8(0x0008) Fix Super Size
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0100(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UMulticastInlineDelegate                               OnSuccess;                                               // 0x0050(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0051(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnFailed;                                                // 0x0060(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0061(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0002[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UMulticastInlineDelegate                               OnFailed;                                                // 0x0060(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0061(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0002[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UMulticastInlineDelegate                               OnAddTrackedGeometry;                                    // 0x00B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x00B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedGeometry;                                 // 0x00C0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x00C1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedGeometry;                                 // 0x00D0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x00D1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedPlane;                                       // 0x00E0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x00E1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedPlane;                                    // 0x00F0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0004[0xF];                                   // 0x00F1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedPlane;                                    // 0x0100(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0005[0xF];                                   // 0x0101(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedPoint;                                       // 0x0110(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0006[0xF];                                   // 0x0111(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedPoint;                                    // 0x0120(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0007[0xF];                                   // 0x0121(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedPoint;                                    // 0x0130(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0008[0xF];                                   // 0x0131(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedImage;                                       // 0x0140(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0009[0xF];                                   // 0x0141(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedImage;                                    // 0x0150(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0010[0xF];                                   // 0x0151(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedImage;                                    // 0x0160(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0011[0xF];                                   // 0x0161(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedFace;                                        // 0x0170(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0012[0xF];                                   // 0x0171(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedFace;                                     // 0x0180(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0013[0xF];                                   // 0x0181(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedFace;                                     // 0x0190(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0014[0xF];                                   // 0x0191(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedEnvProbe;                                    // 0x01A0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0015[0xF];                                   // 0x01A1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedEnvProbe;                                 // 0x01B0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0016[0xF];                                   // 0x01B1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedEnvProbe;                                 // 0x01C0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0017[0xF];                                   // 0x01C1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnAddTrackedObject;                                      // 0x01D0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0018[0xF];                                   // 0x01D1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnUpdateTrackedObject;                                   // 0x01E0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0019[0xF];                                   // 0x01E1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnRemoveTrackedObject;                                   // 0x01F0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0020[0xF];                                   // 0x01F1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x30];                                  // 0x0208(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x20];                                  // 0x0260(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x0105(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<EARFaceBlendShape, float>                               BlendShapes;                                             // 0x0108(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0001[0x38];                                  // 0x0158(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct PCoreUObject_FTransform                               LeftEyeTransform;                                        // 0x0190(0x0030) IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate
		struct PCoreUObject_FTransform                               RightEyeTransform;                                       // 0x01C0(0x0030) IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate

	public:
		struct PCoreUObject_FTransform GetWorldSpaceEyeTransform(EAREye Eye);
		struct PCoreUObject_FTransform GetLocalSpaceEyeTransform(EAREye Eye);
	...
	{
	public:
		TArray<uint8_t>                                              CandidateObjectData;                                     // 0x0030(0x0010) Edit, ZeroConstructor, NativeAccessSpecifierPrivate
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x4];                                   // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x20];                                  // 0x02C0(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UARComponent* AddARComponent(class UARComponent* InComponentClass, const struct FGuid& NativeID);
		static UClass* StaticClass();
	};
	...
	public:
		...
		class UMulticastInlineDelegate                               OnFailed;                                                // 0x0060(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0061(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0002[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UMulticastInlineDelegate                               OnARActorSpawnedDelegate;                                // 0x01F8(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0000[0xF];                                   // 0x0201(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnARActorToBeDestroyedDelegate;                          // 0x0208(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0001[0xF];                                   // 0x0209(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0002[0x18];                                  // 0x0218(0x0018) MISSED OFFSET (PADDING)

	public:
		void ServerSpawnARActor(class UObject* ComponentClass, const struct FGuid& NativeID);
		...
		void InstanceARActorSpawnedDelegate__DelegateSignature(class UObject* ComponentClass, const struct FGuid& NativeID, class AARActor* SpawnedActor);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct PCoreUObject_FTransform                               LocalToTrackingTransform;                                // 0x0040(0x0030) IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate
		struct PCoreUObject_FTransform                               LocalToAlignedTrackingTransform;                         // 0x0070(0x0030) IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate
		...
		unsigned char                                                UnknownData_0001[0x1F];                                  // 0x00A1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMulticastInlineDelegate                               OnARTrackingStateChanged;                                // 0x00C0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x00C1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		class UMulticastInlineDelegate                               OnARTransformUpdated;                                    // 0x00D0(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate
		unsigned char                                                UnknownData_0003[0xF];                                   // 0x00D1(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0004[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x64];                                  // 0x030C(0x0064) MISSED OFFSET (PADDING)
	...
	{
	public:
		TArray<uint8_t>                                              PreviewImageData;                                        // 0x0290(0x0010) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic
		TArray<uint8_t>                                              ARWorldData;                                             // 0x02A0(0x0010) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x02C0(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0570(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0238(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x8];                                   // 0x0198(0x0008) MISSED OFFSET (PADDING)
