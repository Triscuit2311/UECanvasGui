...
namespace SDK
{
	...
	{
	public:
		unsigned char                                                UnknownData_0005[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x4];                                   // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMulticastInlineDelegate                               OnAudioEnvelopeValue;                                    // 0x0658(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                                UnknownData_0002[0xF];                                   // 0x0659(0x000F) FIX WRONG SIZE OF PREVIOUS PROPERTY
		unsigned char                                                UnknownData_0003[0x20];                                  // 0x0668(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0004[0x28];                                  // 0x0698(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x110];                                 // 0x0040(0x0110) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x140];                                 // 0x0028(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x18];                                  // 0x0170(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x88];                                  // 0x0068(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x68];                                  // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
