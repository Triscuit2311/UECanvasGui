...
namespace SDK
{
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(57467);
	...
	{
		static UFunction* fn = UObject::GetObjectCasted<UFunction>(57466);
	...
	{
		static UClass* ptr = UObject::GetObjectCasted<UClass>(57465);
		return ptr;
	}
