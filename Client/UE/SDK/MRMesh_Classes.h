...
namespace SDK
{
	...
	{
	public:
		class UMulticastInlineDelegate                               OnMeshTrackerUpdated;                                    // 0x01F8(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		...
		TArray<struct PCoreUObject_FColor>                           BlockVertexColors;                                       // 0x0210(0x0010) Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
		...
		unsigned char                                                UnknownData_0002[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0003[0x20];                                  // 0x0250(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                                UnknownData_0000[0x10];                                  // 0x0450(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0001[0x5];                                   // 0x0473(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                                UnknownData_0002[0x80];                                  // 0x0490(0x0080) MISSED OFFSET (PADDING)
