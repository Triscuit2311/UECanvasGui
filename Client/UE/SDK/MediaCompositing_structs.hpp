...
static_assert(sizeof(FMovieSceneMediaSectionParams) == 0x000168, "Wrong size on FMovieSceneMediaSectionParams");
...
static_assert(offsetof(FMovieSceneMediaSectionParams, CacheSettings) == 0x000160, "Member 'FMovieSceneMediaSectionParams::CacheSettings' has a wrong offset!");
...
public:
	...
	class UMovieSceneMediaSection*                MediaSection;                                      // 0x0188(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneMediaSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneMediaSectionTemplate");
static_assert(sizeof(FMovieSceneMediaSectionTemplate) == 0x000190, "Wrong size on FMovieSceneMediaSectionTemplate");
...
static_assert(offsetof(FMovieSceneMediaSectionTemplate, MediaSection) == 0x000188, "Member 'FMovieSceneMediaSectionTemplate::MediaSection' has a wrong offset!");
