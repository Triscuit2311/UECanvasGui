...
// Parameters:
// struct FMovieSceneConditionContext      ConditionContext                                       (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Native, Public, HasOutParams)
// Parameters:
// struct FQualifiedFrameTime              InStopTime                                             (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
// struct FFrameTime                       RelevantTime                                           (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
// (Final, RequiredAPI, Net, NetReliable, Native, Event, NetMulticast, Private)
// Parameters:
// struct FFrameTime                       StoppedTime                                            (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// int32                                   NewSerialNumber                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
