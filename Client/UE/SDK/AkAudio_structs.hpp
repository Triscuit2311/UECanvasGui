...
enum class EAkAudioSessionCategoryOptions : uint8
{
	...
	EAkAudioSessionCategoryOptions_MAX       = 65,
};
...
// Enum AkAudio.EAkAudioSessionRouteSharingPolicy
// NumValues: 0x0004
enum class EAkAudioSessionRouteSharingPolicy : uint32
{
	Default                                  = 0,
	LongFormAudio                            = 1,
	LongFormVideo                            = 3,
	EAkAudioSessionRouteSharingPolicy_MAX    = 4,
};
...
// Enum AkAudio.EAkTransmissionOperation
// NumValues: 0x0003
...
public:
	...
	bool                                          bVerboseSink;                                      // 0x003E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAkAndroidAdvancedInitializationSettings, bVerboseSink) == 0x00003E, "Member 'FAkAndroidAdvancedInitializationSettings::bVerboseSink' has a wrong offset!");
...
public:
	...
	EAkAudioSessionRouteSharingPolicy             AudioSessionRouteSharingPolicy;                    // 0x000C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FAkAudioSession, AudioSessionRouteSharingPolicy) == 0x00000C, "Member 'FAkAudioSession::AudioSessionRouteSharingPolicy' has a wrong offset!");
...
public:
	...
	int64                                         IdDevice;                                          // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPanningRule                                  PanRule;                                           // 0x0010(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAkChannelConfiguration                       ChannelConfig;                                     // 0x0011(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAkOutputSettings, PanRule) == 0x000010, "Member 'FAkOutputSettings::PanRule' has a wrong offset!");
static_assert(offsetof(FAkOutputSettings, ChannelConfig) == 0x000011, "Member 'FAkOutputSettings::ChannelConfig' has a wrong offset!");
...
public:
	...
	class UAkExternalMediaAsset*                  ExternalSourceAsset;                               // 0x0028(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UAkAcousticTexture*                     AcousticTexture;                                   // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UPhysicalMaterial*>              ToOverrideAcousticTexture;                         // 0x0030(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UPhysicalMaterial*>              ToOverrideOcclusion;                               // 0x0040(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	uint32                                        MaxDiffractionPaths;                               // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MaxGlobalReflectionPaths;                          // 0x0014(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        DiffractionOrder;                                  // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MaxEmitterRoomAuxSends;                            // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        DiffractionOnReflectionsOrder;                     // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDiffractionAngleDegrees;                        // 0x0024(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumPathLength;                                 // 0x0028(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CPULimitPercentage;                                // 0x002C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SmoothingConstantMs;                               // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        LoadBalancingSpread;                               // 0x0034(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableGeometricDiffractionAndTransmission;         // 0x0038(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          CalcEmitterVirtualPosition;                        // 0x0039(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A[0x2];                                       // 0x003A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	EAkTransmissionOperation                      TransmissionOperation;                             // 0x003C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAkSpatialAudioSettings) == 0x000004, "Wrong alignment on FAkSpatialAudioSettings");
static_assert(sizeof(FAkSpatialAudioSettings) == 0x000040, "Wrong size on FAkSpatialAudioSettings");
...
static_assert(offsetof(FAkSpatialAudioSettings, MaxDiffractionPaths) == 0x000010, "Member 'FAkSpatialAudioSettings::MaxDiffractionPaths' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MaxGlobalReflectionPaths) == 0x000014, "Member 'FAkSpatialAudioSettings::MaxGlobalReflectionPaths' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, DiffractionOrder) == 0x000018, "Member 'FAkSpatialAudioSettings::DiffractionOrder' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MaxEmitterRoomAuxSends) == 0x00001C, "Member 'FAkSpatialAudioSettings::MaxEmitterRoomAuxSends' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, DiffractionOnReflectionsOrder) == 0x000020, "Member 'FAkSpatialAudioSettings::DiffractionOnReflectionsOrder' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MaxDiffractionAngleDegrees) == 0x000024, "Member 'FAkSpatialAudioSettings::MaxDiffractionAngleDegrees' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MaximumPathLength) == 0x000028, "Member 'FAkSpatialAudioSettings::MaximumPathLength' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, CPULimitPercentage) == 0x00002C, "Member 'FAkSpatialAudioSettings::CPULimitPercentage' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, SmoothingConstantMs) == 0x000030, "Member 'FAkSpatialAudioSettings::SmoothingConstantMs' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, LoadBalancingSpread) == 0x000034, "Member 'FAkSpatialAudioSettings::LoadBalancingSpread' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, EnableGeometricDiffractionAndTransmission) == 0x000038, "Member 'FAkSpatialAudioSettings::EnableGeometricDiffractionAndTransmission' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, CalcEmitterVirtualPosition) == 0x000039, "Member 'FAkSpatialAudioSettings::CalcEmitterVirtualPosition' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, TransmissionOperation) == 0x00003C, "Member 'FAkSpatialAudioSettings::TransmissionOperation' has a wrong offset!");
...
// ScriptStruct AkAudio.AkMemoryArenaInitializationSettings
// 0x0024 (0x0024 - 0x0000)
struct FAkMemoryArenaInitializationSettings final
{
public:
	uint32                                        PrimarySbaInitSize;                                // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        PrimaryTlsfInitSize;                               // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        PrimaryTlsfSpanSize;                               // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        PrimaryMemReservedLimit;                           // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        PrimaryAllocSizeHuge;                              // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MediaTlsfInitSize;                                 // 0x0014(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MediaTlsfSpanSize;                                 // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MediaMemReservedLimit;                             // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MediaAllocSizeHuge;                                // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAkMemoryArenaInitializationSettings) == 0x000004, "Wrong alignment on FAkMemoryArenaInitializationSettings");
static_assert(sizeof(FAkMemoryArenaInitializationSettings) == 0x000024, "Wrong size on FAkMemoryArenaInitializationSettings");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, PrimarySbaInitSize) == 0x000000, "Member 'FAkMemoryArenaInitializationSettings::PrimarySbaInitSize' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, PrimaryTlsfInitSize) == 0x000004, "Member 'FAkMemoryArenaInitializationSettings::PrimaryTlsfInitSize' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, PrimaryTlsfSpanSize) == 0x000008, "Member 'FAkMemoryArenaInitializationSettings::PrimaryTlsfSpanSize' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, PrimaryMemReservedLimit) == 0x00000C, "Member 'FAkMemoryArenaInitializationSettings::PrimaryMemReservedLimit' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, PrimaryAllocSizeHuge) == 0x000010, "Member 'FAkMemoryArenaInitializationSettings::PrimaryAllocSizeHuge' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, MediaTlsfInitSize) == 0x000014, "Member 'FAkMemoryArenaInitializationSettings::MediaTlsfInitSize' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, MediaTlsfSpanSize) == 0x000018, "Member 'FAkMemoryArenaInitializationSettings::MediaTlsfSpanSize' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, MediaMemReservedLimit) == 0x00001C, "Member 'FAkMemoryArenaInitializationSettings::MediaMemReservedLimit' has a wrong offset!");
static_assert(offsetof(FAkMemoryArenaInitializationSettings, MediaAllocSizeHuge) == 0x000020, "Member 'FAkMemoryArenaInitializationSettings::MediaAllocSizeHuge' has a wrong offset!");
...
public:
	...
	struct FAkSpatialAudioSettings                SpatialAudioSettings;                              // 0x0040(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAkCommonInitializationSettings) == 0x0000A8, "Wrong size on FAkCommonInitializationSettings");
...
static_assert(offsetof(FAkCommonInitializationSettings, MemoryArenaSettings) == 0x000080, "Member 'FAkCommonInitializationSettings::MemoryArenaSettings' has a wrong offset!");
...
{
public:
	uint32                                        SampleRate;                                        // 0x00A8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAkCommonInitializationSettingsWithSampleRate, SampleRate) == 0x0000A8, "Member 'FAkCommonInitializationSettingsWithSampleRate::SampleRate' has a wrong offset!");
...
public:
	...
	class UPrimitiveComponent*                    Primitive;                                         // 0x0018(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class UAkAcousticTexture*                     Texture;                                           // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAkXboxOneGDKAdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x000038, "Member 'FAkXboxOneGDKAdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
...
public:
	...
	uint16                                        MaximumNumberOfOpusVoices;                         // 0x003A(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        uMaxSystemAudioObjects;                            // 0x003C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MaxXdspStreams;                                    // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        MaxXdspAggregateStreamLength;                      // 0x0044(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableXdspOnLockhart;                              // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x000038, "Member 'FAkXSXAdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, MaximumNumberOfOpusVoices) == 0x00003A, "Member 'FAkXSXAdvancedInitializationSettings::MaximumNumberOfOpusVoices' has a wrong offset!");
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, uMaxSystemAudioObjects) == 0x00003C, "Member 'FAkXSXAdvancedInitializationSettings::uMaxSystemAudioObjects' has a wrong offset!");
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, MaxXdspStreams) == 0x000040, "Member 'FAkXSXAdvancedInitializationSettings::MaxXdspStreams' has a wrong offset!");
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, MaxXdspAggregateStreamLength) == 0x000044, "Member 'FAkXSXAdvancedInitializationSettings::MaxXdspAggregateStreamLength' has a wrong offset!");
static_assert(offsetof(FAkXSXAdvancedInitializationSettings, EnableXdspOnLockhart) == 0x000048, "Member 'FAkXSXAdvancedInitializationSettings::EnableXdspOnLockhart' has a wrong offset!");
...
{
public:
	class UMovieSceneAkAudioEventSection*         Section;                                           // 0x0020(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// ScriptStruct AkAudio.MovieSceneWwiseGameParameterTemplate
// 0x0008 (0x0028 - 0x0020)
struct FMovieSceneWwiseGameParameterTemplate final : public FMovieSceneEvalTemplate
{
public:
	class UMovieSceneWwiseGameParameterSection*   Section;                                           // 0x0020(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneWwiseGameParameterTemplate) == 0x000008, "Wrong alignment on FMovieSceneWwiseGameParameterTemplate");
static_assert(sizeof(FMovieSceneWwiseGameParameterTemplate) == 0x000028, "Wrong size on FMovieSceneWwiseGameParameterTemplate");
static_assert(offsetof(FMovieSceneWwiseGameParameterTemplate, Section) == 0x000020, "Member 'FMovieSceneWwiseGameParameterTemplate::Section' has a wrong offset!");
