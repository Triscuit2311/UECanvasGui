...
namespace SDK
{
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x7];                                   // 0x00F1(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                                UnknownData_0000[0x3];                                   // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
