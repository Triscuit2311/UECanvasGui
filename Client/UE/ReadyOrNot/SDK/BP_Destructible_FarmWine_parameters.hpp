...
struct ABP_Destructible_FarmWine_C_UserConstructionScript_Params
{
public:
	...
	class UStaticMesh*                           CallFunc_Array_Get_Item;                           // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
