...
public:
	...
	uint8                                        Pad_12CB[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FCommonInputTypeInfo                  DefaultGamepadInputTypeInfo;                       // 0xE0(0xA8)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FCommonInputTypeInfo> GamepadInputOverrides;                             // 0x188(0x50)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  TouchInputTypeInfo;                                // 0x1D8(0xA8)(Edit, Protected, NativeAccessSpecifierProtected)
};
