...
public:
	...
	FMulticastInlineDelegateProperty_            XRTrackingOriginChangedDelegate;                   // 0x140(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            XRPlayAreaChangedDelegate;                         // 0x150(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4E9[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4EA[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
